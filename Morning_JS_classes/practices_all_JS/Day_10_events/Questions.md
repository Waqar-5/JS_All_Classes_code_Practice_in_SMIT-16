...
# 135 Theory Questions with Detailed Answers

(15 per topic — Beginner to Advanced)

---

## Topic 49: Reading Field Values

1. What is `.value` in JavaScript?
   **Answer:** It retrieves user-entered data from form fields like input, textarea, and select.
   **Trick:** Input = Value

2. Why not use `.innerText` for inputs?
   **Answer:** Inputs don’t store text nodes; their data lives in `.value`.
   **Trick:** No text inside input

3. When should input values be read?
   **Answer:** Inside event handlers (click, submit, change).
   **Trick:** Read on action

4. What does `.value` return?
   **Answer:** Always a string.
   **Trick:** All input = text

5. How to read textarea content?
   **Answer:** Use `.value`.

6. How to get dropdown value?
   **Answer:** `select.value`

7. What if input is empty?
   **Answer:** Returns empty string.

8. How to read radio button value?
   **Answer:** Find checked radio → `.value`

9. How to read checkbox state?
   **Answer:** Use `.checked`.

10. Can `.value` be undefined?
    **Answer:** No, returns empty string.

11. What event best for validation?
    **Answer:** submit or input.

12. Why read inside event?
    **Answer:** DOM updates after interaction.

13. Can `.value` read hidden input?
    **Answer:** Yes.

14. Read password field?
    **Answer:** `.value`.

15. Common mistake?
    **Answer:** Using `.innerText`.

---

## Topic 50: Setting Field Values

16. How to set input value?
    **Answer:** `input.value = 'text'`

17. How to clear field?
    **Answer:** `value = ''`

18. Prefill from API?
    **Answer:** Assign API data to `.value`.

19. Set textarea text?
    **Answer:** `.value`

20. Reset form?
    **Answer:** `form.reset()`

21. Default select option?
    **Answer:** Set `.value`.
...
24. When to set values?
    **Answer:** After DOM load.

25. Set multiple inputs?
    **Answer:** Loop and assign `.value`.

26. Set password programmatically?
    **Answer:** Yes via `.value`.

27. Disable input?
    **Answer:** `disabled = true`

28. Auto-fill use case?
    **Answer:** Login forms.

29. Security risk?
    **Answer:** Exposing passwords.

30. Best practice?
    **Answer:** Validate before setting.

---

## Topic 51: Paragraph Text

31. What is `.innerText`?
    **Answer:** Visible text only.

32. What is `.textContent`?
    **Answer:** Raw text.

33. What is `.innerHTML`?
    **Answer:** HTML markup.
...
43. Why avoid innerHTML?
    **Answer:** XSS risk.

44. Accessibility?
    **Answer:** Use `.innerText`.

45. Exam trick?
    **Answer:** HTML = dangerous.
...
51. Animate text?
    **Answer:** CSS + classList.

52. Hover image?
    **Answer:** onmouseover + src.

53. SEO tip?
    **Answer:** meaningful alt.

54. Change hero image?
    **Answer:** `.src`.
...
58. Lazy load?
    **Answer:** loading attribute.

59. Responsive image?
    **Answer:** srcset.

60. Best practice?
    **Answer:** preload images.
...
106. Select all p?
     **Answer:** getElementsByTagName or querySelectorAll.
...
117. Read text?
     **Answer:** loop + innerText.

118. Add class?
     **Answer:** loop + classList.
